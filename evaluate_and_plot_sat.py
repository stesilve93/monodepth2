...
MODEL_PATHS = {
    "MSE Train Original": "models/mono_1024x320/trained_env/dem/combined/u16_mid-range/", 
...
for i in range(0,30):
    image_path = f"/home/massi/Documents/datasets/traj_test/images_bw/frame-vis-{i:05d}.png"
    ...
    # Salva la depth map
    output_depth_path = os.path.join("/home/massi/Documents/datasets/traj_test/depths/inferred",os.path.basename(image_path))  # Specifica il percorso di salvataggio
